function liveChartFunctionWorker(switchkey) {
...
function liveChartFunctionNID(switchkey) {
    var data = [], totalPoints = 100;
...
$('#workerBotStartButton').click(
    function () {
        ...
        $('#workerBotStartButton').addClass("c-btn--secondary");
        $('#workerBotStartButton').addClass("c-btn--disabled");
        $('#workerBotStartButton').click(false);
        $('#workerBotStartButton').attr("aria-disabled", true);
        ...
        $('#interactive').empty();
        lgraph = liveChartFunctionWorker('on');
...
$('#nidBotStartButton').click(
    function () {
        ...
        $('#nidBotStartButton').addClass("c-btn--secondary");
        $('#nidBotStartButton').addClass("c-btn--disabled");
        $('#nidBotStartButton').click(false);
        $('#nidBotStartButton').attr("aria-disabled", true);
        ...
        lgraph = liveChartFunctionNID('on');
...
function LoadLiveNidBotStatus(t_id) {
    ...
    if (sendSomething.status == true) {
        ...
        $("#nid_bot-runbutton-msg").text("Done").css("color", "#822ac7");
        $('#nidBotStartButton').removeClass("c-btn--secondary");
        $('#nidBotStartButton').removeClass("c-btn--disabled");
        $('#nidBotStartButton').attr("aria-disabled", false);

        $('#interactive').empty();
        lgraph = liveChartFunctionNID('off');
    }
...
function LoadLiveWorkerBotStatus(t_id) {
    ...
    if (sendSomething.status == true) {
        ...
        $("#worker_bot-runbutton-msg").text("Done").css("color", "#822ac7");
        $('#workerBotStartButton').removeClass("c-btn--secondary");
        $('#workerBotStartButton').removeClass("c-btn--disabled");
        $('#workerBotStartButton').attr("aria-disabled", false);

        $('#interactive').empty();
        lgraph = liveChartFunctionWorker('off');
    }
